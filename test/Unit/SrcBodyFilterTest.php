...
use Horde\Smtp\BodyFilter;
use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\TestCase;
use stdClass;

#[CoversClass(BodyFilter::class)]
class SrcBodyFilterTest extends TestCase
{
    ...
    public function testBodyFilter(string $data, string|false $result): void
    {
        ...
        $filterId = 'horde.smtp.body.' . bin2hex(random_bytes(4));
        stream_filter_register($filterId, BodyFilter::class);
